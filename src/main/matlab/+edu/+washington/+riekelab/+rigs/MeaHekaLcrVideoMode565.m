    ...
    methods
        ...
        function obj = MeaHekaLcrVideoMode565()
            ...
            lightCrafter.addResource('fluxFactorPaths', containers.Map( ...
                ...
                riekelab.Package.getCalibrationResource('rigs', 'suction', 'lightcrafter_below_red565_flux_factors.txt'), ...
                riekelab.Package.getCalibrationResource('rigs', 'suction', 'lightcrafter_below_green565_flux_factors.txt'), ...
                riekelab.Package.getCalibrationResource('rigs', 'suction', 'lightcrafter_below_blue565_flux_factors.txt')}));
            ...
            myspect = containers.Map( ...
                ...
                importdata(riekelab.Package.getCalibrationResource('rigs', 'suction', 'lightcrafter_below_red565_spectrum.txt')), ...
                importdata(riekelab.Package.getCalibrationResource('rigs', 'suction', 'lightcrafter_below_green565_spectrum.txt')), ...
                importdata(riekelab.Package.getCalibrationResource('rigs', 'suction', 'lightcrafter_below_blue565_spectrum.txt'))});
            ...
            % Re-measured FWNDs on 03.06.2026
...
%                     {0, 0.5305, 1.0502, 2.4253, 3.6195, 4.8356,0.2663, 0.5389, 0.9569, 2.0810, 2.3747})}));
            ...
            lightCrafter.addResource('ndfAttenuations', containers.Map( ...
                ...
                containers.Map( ...
                    {'FW00', 'FW05', 'FW10', 'FW20', 'FW30', 'FW40','C1', 'C2', 'C3', 'C4', 'C5'}, ...
                    {0, 0.5190, 1.0253, 2.1930, 3.2688, 4.3003,0.2866, 0.5933, 0.9675, 1.9279, 2.1372}), ...
                containers.Map( ...
                    {'FW00', 'FW05', 'FW10', 'FW20', 'FW30', 'FW40','C1', 'C2', 'C3', 'C4', 'C5'}, ...
                    {0, 0.5169, 1.0207, 2.0768, 3.1011, 4.0390,0.2866, 0.5933, 0.9675, 1.9279, 2.1372}), ...
                containers.Map( ...
                    {'FW00', 'FW05', 'FW10', 'FW20', 'FW30', 'FW40','C1', 'C2', 'C3', 'C4', 'C5'}, ...
                    {0, 0.5096, 1.0083, 2.1504, 3.2176, 4.1854,0.2866, 0.5933, 0.9675, 1.9279, 2.1372}), ...
                containers.Map( ...
                    {'FW00', 'FW05', 'FW10', 'FW20', 'FW30', 'FW40','C1', 'C2', 'C3', 'C4', 'C5'}, ...
                    {0, 0.5399, 1.0665, 2.4569, 3.6092, 4.3082,0.2663, 0.5389, 0.9569, 2.0810, 2.3747})}));
