classdef MeaHekaLcrVideoMode565 < symphonyui.core.descriptions.RigDescription
    ...
    methods
        ...
        function obj = MeaHekaLcrVideoMode565()
            ...
            % Re-measured FWNDs on 03.13.2026
...
%                     {0, 0.5305, 1.0502, 2.4253, 3.6195, 4.8356,0.2663, 0.5389, 0.9569, 2.0810, 2.3747})}));
            ...
            lightCrafter.addResource('ndfAttenuations', containers.Map( ...
                ...
                containers.Map( ...
                    {'FW00', 'FW05', 'FW10', 'FW20', 'FW30', 'FW40','C1', 'C2', 'C3', 'C4', 'C5'}, ...
                    {0, 0.5158, 1.0184, 2.1803, 3.2544, 4.2858, 0.2866, 0.5933, 0.9675, 1.9279, 2.1372}), ...
                containers.Map( ...
                    {'FW00', 'FW05', 'FW10', 'FW20', 'FW30', 'FW40','C1', 'C2', 'C3', 'C4', 'C5'}, ...
                    {0, 0.5139, 1.0149, 2.0668, 3.1071, 4.0733, 0.2866, 0.5933, 0.9675, 1.9279, 2.1372}), ...
                containers.Map( ...
                    {'FW00', 'FW05', 'FW10', 'FW20', 'FW30', 'FW40','C1', 'C2', 'C3', 'C4', 'C5'}, ...
                    {0, 0.5067, 1.0007, 2.1367, 3.2025, 4.1859, 0.2866, 0.5933, 0.9675, 1.9279, 2.1372}), ...
                containers.Map( ...
                    {'FW00', 'FW05', 'FW10', 'FW20', 'FW30', 'FW40','C1', 'C2', 'C3', 'C4', 'C5'}, ...
                    {0, 0.5361, 1.0591, 2.4454, 3.6739, 4.4868, 0.2663, 0.5389, 0.9569, 2.0810, 2.3747})}));
