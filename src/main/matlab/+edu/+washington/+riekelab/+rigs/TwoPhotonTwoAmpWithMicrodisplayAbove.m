classdef TwoPhotonTwoAmpWithMicrodisplayAbove < edu.washington.riekelab.rigs.TwoPhotonWithMicrodisplayAbove
    
    methods
        
        function obj = TwoPhotonTwoAmpWithMicrodisplayAbove()
