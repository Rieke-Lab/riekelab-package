classdef SharedTwoPhotonWithLedAboveWithoutBlueFilter < symphonyui.core.descriptions.RigDescription
    ...
    methods
        ...
        function obj = SharedTwoPhotonWithLedAboveWithoutBlueFilter()
            ...
            redRamp = importdata(riekelab.Package.getCalibrationResource('rigs', 'shared_two_photon', 'red_led_gamma_ramp_lineB.txt'));
            ...
            red.addResource('fluxFactorPaths', containers.Map( ...
                {'none'}, {riekelab.Package.getCalibrationResource('rigs', 'shared_two_photon', 'red_led_flux_factors_lineB.txt')}));
            red.addConfigurationSetting('lightPath', '', ...
                'type', PropertyType('char', 'row', {'', 'below', 'above'}));
            red.addResource('spectrum', importdata(riekelab.Package.getCalibrationResource('rigs', 'shared_two_photon', 'red_led_spectrum_lineB.txt')));            
            obj.addDevice(red);
            
            uvRamp = importdata(riekelab.Package.getCalibrationResource('rigs', 'shared_two_photon', 'uv_led_gamma_ramp_lineB.txt'));
            ...
            uv.addConfigurationSetting('ndfs', {}, ...
                'type', PropertyType('cellstr', 'row', {'EL03','EL06','ES03','EL1', 'EL2', 'EL3','G1', 'G2', 'G3', 'G4', 'G6', 'G7', 'G8', 'G9'}));
            uv.addResource('ndfAttenuations', containers.Map( ...
                {'EL03','EL06','ES03','EL1', 'EL2', 'EL3','G1', 'G2', 'G3', 'G4', 'G6', 'G7', 'G8', 'G9'}, ...
                {0.29,0.62,0.26,0.97, 2.11, 4.23,1.0060, 1.0524, 2.1342, 2.6278, 0.28, 0.59, 1.25, 2.23}));
            uv.addResource('fluxFactorPaths', containers.Map( ...
                {'none'}, {riekelab.Package.getCalibrationResource('rigs', 'shared_two_photon', 'uv_led_flux_factors_lineB.txt')}));
            uv.addConfigurationSetting('lightPath', '', ...
                'type', PropertyType('char', 'row', {'', 'below', 'above'}));
            uv.addResource('spectrum', importdata(riekelab.Package.getCalibrationResource('rigs', 'shared_two_photon', 'uv_led_spectrum_lineB.txt')));          
            obj.addDevice(uv);
%             
            blueRamp = importdata(riekelab.Package.getCalibrationResource('rigs', 'shared_two_photon', 'blue_led_gamma_ramp_lineB.txt'));
            ...
            blue.addResource('fluxFactorPaths', containers.Map( ...
                {'none'}, {riekelab.Package.getCalibrationResource('rigs', 'shared_two_photon', 'blue_led_flux_factors_lineB.txt')}));
