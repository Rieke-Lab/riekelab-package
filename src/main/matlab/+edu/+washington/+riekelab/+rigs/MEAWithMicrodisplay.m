classdef MEAWithMicrodisplay < symphonyui.core.descriptions.RigDescription
    ...
    methods
        ...
        function obj = MEAWithMicrodisplay()
            ...
            microdisplay = riekelab.devices.MicrodisplayDevice('gammaRamps', ramps, 'micronsPerPixel', 3.0, 'comPort', 'COM5');
%             microdisplay = riekelab.devices.MicrodisplayDevice('gammaRamps', ramps, 'micronsPerPixel', 3.0, 'comPort', 'COM1', 'host', '192.168.0.102');
