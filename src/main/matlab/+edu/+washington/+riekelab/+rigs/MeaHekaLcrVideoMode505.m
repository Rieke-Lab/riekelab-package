classdef MeaHekaLcrVideoMode505 < symphonyui.core.descriptions.RigDescription
    ...
    methods
        ...
        function obj = MeaHekaLcrVideoMode505()
            ...
            % New FWND Measurements Made 03.13.2026
...
%                     {0, 0.5305, 1.0502, 2.4253, 3.6195, 4.8356,0.2663, 0.5389, 0.9569, 2.0810, 2.3747})}));
            ...
            lightCrafter.addResource('ndfAttenuations', containers.Map( ...
                ...
                containers.Map( ...
                    {'FW00', 'FW05', 'FW10', 'FW20', 'FW30', 'FW40','C1', 'C2', 'C3', 'C4', 'C5'}, ...
                    {0, 0.5168, 1.0213, 2.2078, 3.3021, 4.3268, 0.2866, 0.5933, 0.9675, 1.9279, 2.1372}), ...
                containers.Map( ...
                    {'FW00', 'FW05', 'FW10', 'FW20', 'FW30', 'FW40','C1', 'C2', 'C3', 'C4', 'C5'}, ...
                    {0, 0.5131, 1.0143, 2.0718, 3.0977, 4.0868, 0.2866, 0.5933, 0.9675, 1.9279, 2.1372}), ...
                containers.Map( ...
                    {'FW00', 'FW05', 'FW10', 'FW20', 'FW30', 'FW40','C1', 'C2', 'C3', 'C4', 'C5'}, ...
                    {0, 0.5111, 1.0084, 2.1860, 3.2831, 4.3131, 0.2866, 0.5933, 0.9675, 1.9279, 2.1372}), ...
                containers.Map( ...
                    {'FW00', 'FW05', 'FW10', 'FW20', 'FW30', 'FW40','C1', 'C2', 'C3', 'C4', 'C5'}, ...
                    {0, 0.5359, 1.0586, 2.4435, 3.6759, 4.4889, 0.2663, 0.5389, 0.9569, 2.0810, 2.3747})}));    
