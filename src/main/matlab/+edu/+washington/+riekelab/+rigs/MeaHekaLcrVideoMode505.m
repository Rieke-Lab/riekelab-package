classdef MeaHekaLcrVideoMode505 < symphonyui.core.descriptions.RigDescription
    ...
    methods
        ...
        function obj = MeaHekaLcrVideoMode505()
            ...
            % New FWND Measurements Made 03.06.2026
...
%                     {0, 0.5305, 1.0502, 2.4253, 3.6195, 4.8356,0.2663, 0.5389, 0.9569, 2.0810, 2.3747})}));
            ...
            lightCrafter.addResource('ndfAttenuations', containers.Map( ...
                ...
                containers.Map( ...
                    {'FW00', 'FW05', 'FW10', 'FW20', 'FW30', 'FW40','C1', 'C2', 'C3', 'C4', 'C5'}, ...
                    {0, 0.5202, 1.0282, 2.2217, 3.3174, 4.4068, 0.2866, 0.5933, 0.9675, 1.9279, 2.1372}), ...
                containers.Map( ...
                    {'FW00', 'FW05', 'FW10', 'FW20', 'FW30', 'FW40','C1', 'C2', 'C3', 'C4', 'C5'}, ...
                    {0, 0.5166, 1.0208, 2.0852, 3.1226, 4.2298, 0.2866, 0.5933, 0.9675, 1.9279, 2.1372}), ...
                containers.Map( ...
                    {'FW00', 'FW05', 'FW10', 'FW20', 'FW30', 'FW40','C1', 'C2', 'C3', 'C4', 'C5'}, ...
                    {0, 0.5135, 1.0160, 2.2023, 3.3056, 4.4111, 0.2866, 0.5933, 0.9675, 1.9279, 2.1372}), ...
                containers.Map( ...
                    {'FW00', 'FW05', 'FW10', 'FW20', 'FW30', 'FW40','C1', 'C2', 'C3', 'C4', 'C5'}, ...
                    {0, 0.5399, 1.0671, 2.4597, 3.6589, 4.6132, 0.2663, 0.5389, 0.9569, 2.0810, 2.3747})}));    
